...
namespace rs {
    ...
    template <typename T>
    void recursive_filter_horizontal(void* image_data, float alpha, float deltaZ, uint8_t holes_filling_radius, img_details &details)
    {
        size_t v{}, u{};
    ...
    template <typename T>
    void recursive_filter_vertical(void* image_data, float alpha, float deltaZ, uint8_t holes_filling_radius, img_details &details)
    {
        size_t v{}, u{};
    ...
    template <typename T>
    inline void intertial_holes_fill(T* image_data, uint8_t holes_filling_radius, img_details &details)
    {
    ...
    template <typename T>
    void dxf_smooth(void* frame_data, float alpha, float delta, int iterations, uint8_t holes_filling_mode, uint8_t holes_filling_radius, img_details &details)
    {
        ...
        if (holes_filling_mode && fp)
            intertial_holes_fill<T>(static_cast<T*>(frame_data), holes_filling_radius, details);
    }
